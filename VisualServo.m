...
%CURRENTLY FULLY WORKING EXAMPLE OF VISUAL SERVOING WITH THE IIWA ROBOT. USES 2 DEFINED CARTESIAN POINTS 
%TO ALIGN TO THE CENTRE OF CAMERA VIEW TO (close to) END EFFECTOR.
