classdef Gripper < handle
    ...
    methods%% Class for UR5 robot simulation
        ...
        function GetRobot(self)
            ...
            L1 = Link('d',0,'a',0,'alpha',-pi/2,'qlim',deg2rad([70 90]), 'offset',0)
        ...
        function PlotAndColourRobot(self)%robot,workspace)
            for linkIndex = 0:self.model.n
                if self.useGripper && linkIndex == self.model.n
                    [ faceData, vertexData, plyData{linkIndex+1} ] = plyread(['Gripper_',num2str(linkIndex),'Gripper.ply'],'tri'); %#ok<AGROW>
                else
